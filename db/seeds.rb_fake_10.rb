...
course_0_A = Course.find_or_create_by_name(:user_id => mentor_0.id, :name => 'course 0 A', :price => 10, :capacity => 100, :address => '1 Hollister Ave, Goleta, CA')
course_0_B = Course.find_or_create_by_name(:user_id => mentor_0.id, :name => 'course 0 B', :price => 10, :capacity => 100, :address => '1 El Colegio Rd, Goleta, CA')
course_0_C = Course.find_or_create_by_name(:user_id => mentor_0.id, :name => 'course 0 C', :price => 10, :capacity => 100, :address => '1 Mission Street, Santa Barbara, CA')
course_0_D = Course.find_or_create_by_name(:user_id => mentor_0.id, :name => 'course 0 D', :price => 10, :capacity => 100, :address => '1 State Street, Santa Barbara, CA')
course_0_E = Course.find_or_create_by_name(:user_id => mentor_0.id, :name => 'course 0 E', :price => 10, :capacity => 100, :address => '1 De La Vina Street, Santa Barbara, CA')
...
course_2_A = Course.find_or_create_by_name(:user_id => mentor_2.id, :name => 'course 2 A', :price => 10, :capacity => 100, :address => '1 Hollister Ave, Goleta, CA')
course_2_B = Course.find_or_create_by_name(:user_id => mentor_2.id, :name => 'course 2 B', :price => 10, :capacity => 100, :address => '1 El Colegio Rd, Goleta, CA')
course_2_C = Course.find_or_create_by_name(:user_id => mentor_2.id, :name => 'course 2 C', :price => 10, :capacity => 100, :address => '1 Mission Street, Santa Barbara, CA')
course_2_D = Course.find_or_create_by_name(:user_id => mentor_2.id, :name => 'course 2 D', :price => 10, :capacity => 100, :address => '1 State Street, Santa Barbara, CA')
course_2_E = Course.find_or_create_by_name(:user_id => mentor_2.id, :name => 'course 2 E', :price => 10, :capacity => 100, :address => '1 De La Vina Street, Santa Barbara, CA')
course_3_A = Course.find_or_create_by_name(:user_id => mentor_3.id, :name => 'course 3 A', :price => 10, :capacity => 100, :address => '1 Hollister Ave, Goleta, CA')
course_3_B = Course.find_or_create_by_name(:user_id => mentor_3.id, :name => 'course 3 B', :price => 10, :capacity => 100, :address => '1 El Colegio Rd, Goleta, CA')
course_3_C = Course.find_or_create_by_name(:user_id => mentor_3.id, :name => 'course 3 C', :price => 10, :capacity => 100, :address => '1 Mission Street, Santa Barbara, CA')
course_3_D = Course.find_or_create_by_name(:user_id => mentor_3.id, :name => 'course 3 D', :price => 10, :capacity => 100, :address => '1 State Street, Santa Barbara, CA')
course_3_E = Course.find_or_create_by_name(:user_id => mentor_3.id, :name => 'course 3 E', :price => 10, :capacity => 100, :address => '1 De La Vina Street, Santa Barbara, CA')
course_4_A = Course.find_or_create_by_name(:user_id => mentor_4.id, :name => 'course 4 A', :price => 10, :capacity => 100, :address => '1 Hollister Ave, Goleta, CA')
course_4_B = Course.find_or_create_by_name(:user_id => mentor_4.id, :name => 'course 4 B', :price => 10, :capacity => 100, :address => '1 El Colegio Rd, Goleta, CA')
course_4_C = Course.find_or_create_by_name(:user_id => mentor_4.id, :name => 'course 4 C', :price => 10, :capacity => 100, :address => '1 Mission Street, Santa Barbara, CA')
course_4_D = Course.find_or_create_by_name(:user_id => mentor_4.id, :name => 'course 4 D', :price => 10, :capacity => 100, :address => '1 State Street, Santa Barbara, CA')
course_4_E = Course.find_or_create_by_name(:user_id => mentor_4.id, :name => 'course 4 E', :price => 10, :capacity => 100, :address => '1 De La Vina Street, Santa Barbara, CA')
course_5_A = Course.find_or_create_by_name(:user_id => mentor_5.id, :name => 'course 5 A', :price => 10, :capacity => 100, :address => '1 Hollister Ave, Goleta, CA')
course_5_B = Course.find_or_create_by_name(:user_id => mentor_5.id, :name => 'course 5 B', :price => 10, :capacity => 100, :address => '1 El Colegio Rd, Goleta, CA')
course_5_C = Course.find_or_create_by_name(:user_id => mentor_5.id, :name => 'course 5 C', :price => 10, :capacity => 100, :address => '1 Mission Street, Santa Barbara, CA')
course_5_D = Course.find_or_create_by_name(:user_id => mentor_5.id, :name => 'course 5 D', :price => 10, :capacity => 100, :address => '1 State Street, Santa Barbara, CA')
course_5_E = Course.find_or_create_by_name(:user_id => mentor_5.id, :name => 'course 5 E', :price => 10, :capacity => 100, :address => '1 De La Vina Street, Santa Barbara, CA')
course_6_A = Course.find_or_create_by_name(:user_id => mentor_6.id, :name => 'course 6 A', :price => 10, :capacity => 100, :address => '1 Hollister Ave, Goleta, CA')
course_6_B = Course.find_or_create_by_name(:user_id => mentor_6.id, :name => 'course 6 B', :price => 10, :capacity => 100, :address => '1 El Colegio Rd, Goleta, CA')
course_6_C = Course.find_or_create_by_name(:user_id => mentor_6.id, :name => 'course 6 C', :price => 10, :capacity => 100, :address => '1 Mission Street, Santa Barbara, CA')
course_6_D = Course.find_or_create_by_name(:user_id => mentor_6.id, :name => 'course 6 D', :price => 10, :capacity => 100, :address => '1 State Street, Santa Barbara, CA')
course_6_E = Course.find_or_create_by_name(:user_id => mentor_6.id, :name => 'course 6 E', :price => 10, :capacity => 100, :address => '1 De La Vina Street, Santa Barbara, CA')
course_7_A = Course.find_or_create_by_name(:user_id => mentor_7.id, :name => 'course 7 A', :price => 10, :capacity => 100, :address => '1 Hollister Ave, Goleta, CA')
course_7_B = Course.find_or_create_by_name(:user_id => mentor_7.id, :name => 'course 7 B', :price => 10, :capacity => 100, :address => '1 El Colegio Rd, Goleta, CA')
course_7_C = Course.find_or_create_by_name(:user_id => mentor_7.id, :name => 'course 7 C', :price => 10, :capacity => 100, :address => '1 Mission Street, Santa Barbara, CA')
course_7_D = Course.find_or_create_by_name(:user_id => mentor_7.id, :name => 'course 7 D', :price => 10, :capacity => 100, :address => '1 State Street, Santa Barbara, CA')
course_7_E = Course.find_or_create_by_name(:user_id => mentor_7.id, :name => 'course 7 E', :price => 10, :capacity => 100, :address => '1 De La Vina Street, Santa Barbara, CA')
course_8_A = Course.find_or_create_by_name(:user_id => mentor_8.id, :name => 'course 8 A', :price => 10, :capacity => 100, :address => '1 Hollister Ave, Goleta, CA')
course_8_B = Course.find_or_create_by_name(:user_id => mentor_8.id, :name => 'course 8 B', :price => 10, :capacity => 100, :address => '1 El Colegio Rd, Goleta, CA')
course_8_C = Course.find_or_create_by_name(:user_id => mentor_8.id, :name => 'course 8 C', :price => 10, :capacity => 100, :address => '1 Mission Street, Santa Barbara, CA')
course_8_D = Course.find_or_create_by_name(:user_id => mentor_8.id, :name => 'course 8 D', :price => 10, :capacity => 100, :address => '1 State Street, Santa Barbara, CA')
course_8_E = Course.find_or_create_by_name(:user_id => mentor_8.id, :name => 'course 8 E', :price => 10, :capacity => 100, :address => '1 De La Vina Street, Santa Barbara, CA')
course_9_A = Course.find_or_create_by_name(:user_id => mentor_9.id, :name => 'course 9 A', :price => 10, :capacity => 100, :address => '1 Hollister Ave, Goleta, CA')
course_9_B = Course.find_or_create_by_name(:user_id => mentor_9.id, :name => 'course 9 B', :price => 10, :capacity => 100, :address => '1 El Colegio Rd, Goleta, CA')
course_9_C = Course.find_or_create_by_name(:user_id => mentor_9.id, :name => 'course 9 C', :price => 10, :capacity => 100, :address => '1 Mission Street, Santa Barbara, CA')
course_9_D = Course.find_or_create_by_name(:user_id => mentor_9.id, :name => 'course 9 D', :price => 10, :capacity => 100, :address => '1 State Street, Santa Barbara, CA')
course_9_E = Course.find_or_create_by_name(:user_id => mentor_9.id, :name => 'course 9 E', :price => 10, :capacity => 100, :address => '1 De La Vina Street, Santa Barbara, CA')
