...
course_0_A = Course.find_or_create_by_name(:user_id => mentor_0.id, :name => 'course 0 A', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.873, :latitude => 34.424)
course_0_B = Course.find_or_create_by_name(:user_id => mentor_0.id, :name => 'course 0 B', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.848, :latitude => 34.466)
course_0_C = Course.find_or_create_by_name(:user_id => mentor_0.id, :name => 'course 0 C', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.835, :latitude => 34.427)
course_0_D = Course.find_or_create_by_name(:user_id => mentor_0.id, :name => 'course 0 D', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.814, :latitude => 34.403)
course_0_E = Course.find_or_create_by_name(:user_id => mentor_0.id, :name => 'course 0 E', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.875, :latitude => 34.480)
course_1_A = Course.find_or_create_by_name(:user_id => mentor_1.id, :name => 'course 1 A', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.817, :latitude => 34.435)
course_1_B = Course.find_or_create_by_name(:user_id => mentor_1.id, :name => 'course 1 B', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.820, :latitude => 34.415)
course_1_C = Course.find_or_create_by_name(:user_id => mentor_1.id, :name => 'course 1 C', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.878, :latitude => 34.463)
course_1_D = Course.find_or_create_by_name(:user_id => mentor_1.id, :name => 'course 1 D', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.870, :latitude => 34.488)
course_1_E = Course.find_or_create_by_name(:user_id => mentor_1.id, :name => 'course 1 E', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.872, :latitude => 34.468)
course_2_A = Course.find_or_create_by_name(:user_id => mentor_2.id, :name => 'course 2 A', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.853, :latitude => 34.456)
course_2_B = Course.find_or_create_by_name(:user_id => mentor_2.id, :name => 'course 2 B', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.832, :latitude => 34.461)
course_2_C = Course.find_or_create_by_name(:user_id => mentor_2.id, :name => 'course 2 C', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.853, :latitude => 34.492)
course_2_D = Course.find_or_create_by_name(:user_id => mentor_2.id, :name => 'course 2 D', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.877, :latitude => 34.469)
course_2_E = Course.find_or_create_by_name(:user_id => mentor_2.id, :name => 'course 2 E', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.890, :latitude => 34.433)
course_3_A = Course.find_or_create_by_name(:user_id => mentor_3.id, :name => 'course 3 A', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.891, :latitude => 34.470)
course_3_B = Course.find_or_create_by_name(:user_id => mentor_3.id, :name => 'course 3 B', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.810, :latitude => 34.425)
course_3_C = Course.find_or_create_by_name(:user_id => mentor_3.id, :name => 'course 3 C', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.878, :latitude => 34.479)
course_3_D = Course.find_or_create_by_name(:user_id => mentor_3.id, :name => 'course 3 D', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.868, :latitude => 34.431)
course_3_E = Course.find_or_create_by_name(:user_id => mentor_3.id, :name => 'course 3 E', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.825, :latitude => 34.456)
course_4_A = Course.find_or_create_by_name(:user_id => mentor_4.id, :name => 'course 4 A', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.855, :latitude => 34.438)
course_4_B = Course.find_or_create_by_name(:user_id => mentor_4.id, :name => 'course 4 B', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.833, :latitude => 34.488)
course_4_C = Course.find_or_create_by_name(:user_id => mentor_4.id, :name => 'course 4 C', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.844, :latitude => 34.480)
course_4_D = Course.find_or_create_by_name(:user_id => mentor_4.id, :name => 'course 4 D', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.801, :latitude => 34.487)
course_4_E = Course.find_or_create_by_name(:user_id => mentor_4.id, :name => 'course 4 E', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.873, :latitude => 34.467)
course_5_A = Course.find_or_create_by_name(:user_id => mentor_5.id, :name => 'course 5 A', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.816, :latitude => 34.488)
course_5_B = Course.find_or_create_by_name(:user_id => mentor_5.id, :name => 'course 5 B', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.889, :latitude => 34.461)
course_5_C = Course.find_or_create_by_name(:user_id => mentor_5.id, :name => 'course 5 C', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.843, :latitude => 34.477)
course_5_D = Course.find_or_create_by_name(:user_id => mentor_5.id, :name => 'course 5 D', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.858, :latitude => 34.421)
course_5_E = Course.find_or_create_by_name(:user_id => mentor_5.id, :name => 'course 5 E', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.844, :latitude => 34.439)
course_6_A = Course.find_or_create_by_name(:user_id => mentor_6.id, :name => 'course 6 A', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.857, :latitude => 34.464)
course_6_B = Course.find_or_create_by_name(:user_id => mentor_6.id, :name => 'course 6 B', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.860, :latitude => 34.411)
course_6_C = Course.find_or_create_by_name(:user_id => mentor_6.id, :name => 'course 6 C', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.878, :latitude => 34.493)
course_6_D = Course.find_or_create_by_name(:user_id => mentor_6.id, :name => 'course 6 D', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.876, :latitude => 34.496)
course_6_E = Course.find_or_create_by_name(:user_id => mentor_6.id, :name => 'course 6 E', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.870, :latitude => 34.467)
course_7_A = Course.find_or_create_by_name(:user_id => mentor_7.id, :name => 'course 7 A', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.849, :latitude => 34.484)
course_7_B = Course.find_or_create_by_name(:user_id => mentor_7.id, :name => 'course 7 B', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.892, :latitude => 34.410)
course_7_C = Course.find_or_create_by_name(:user_id => mentor_7.id, :name => 'course 7 C', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.899, :latitude => 34.410)
course_7_D = Course.find_or_create_by_name(:user_id => mentor_7.id, :name => 'course 7 D', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.836, :latitude => 34.430)
course_7_E = Course.find_or_create_by_name(:user_id => mentor_7.id, :name => 'course 7 E', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.889, :latitude => 34.414)
course_8_A = Course.find_or_create_by_name(:user_id => mentor_8.id, :name => 'course 8 A', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.894, :latitude => 34.455)
course_8_B = Course.find_or_create_by_name(:user_id => mentor_8.id, :name => 'course 8 B', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.839, :latitude => 34.414)
course_8_C = Course.find_or_create_by_name(:user_id => mentor_8.id, :name => 'course 8 C', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.837, :latitude => 34.450)
course_8_D = Course.find_or_create_by_name(:user_id => mentor_8.id, :name => 'course 8 D', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.877, :latitude => 34.450)
course_8_E = Course.find_or_create_by_name(:user_id => mentor_8.id, :name => 'course 8 E', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.897, :latitude => 34.405)
course_9_A = Course.find_or_create_by_name(:user_id => mentor_9.id, :name => 'course 9 A', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.820, :latitude => 34.453)
course_9_B = Course.find_or_create_by_name(:user_id => mentor_9.id, :name => 'course 9 B', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.842, :latitude => 34.419)
course_9_C = Course.find_or_create_by_name(:user_id => mentor_9.id, :name => 'course 9 C', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.899, :latitude => 34.418)
course_9_D = Course.find_or_create_by_name(:user_id => mentor_9.id, :name => 'course 9 D', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.857, :latitude => 34.431)
course_9_E = Course.find_or_create_by_name(:user_id => mentor_9.id, :name => 'course 9 E', :price => 10, :capacity => 1000, :address => 'machine generated address', :longitude => -119.876, :latitude => 34.438)
...
Enrollment.create(:user_id => student_0.id, :course_id => course_0_A.id)
Enrollment.create(:user_id => student_0.id, :course_id => course_0_B.id)
Enrollment.create(:user_id => student_1.id, :course_id => course_0_B.id)
Enrollment.create(:user_id => student_1.id, :course_id => course_0_C.id)
Enrollment.create(:user_id => student_2.id, :course_id => course_0_C.id)
Enrollment.create(:user_id => student_2.id, :course_id => course_0_D.id)
Enrollment.create(:user_id => student_3.id, :course_id => course_0_D.id)
Enrollment.create(:user_id => student_3.id, :course_id => course_0_E.id)
Enrollment.create(:user_id => student_4.id, :course_id => course_0_E.id)
Enrollment.create(:user_id => student_4.id, :course_id => course_0_A.id)
Enrollment.create(:user_id => student_5.id, :course_id => course_0_A.id)
Enrollment.create(:user_id => student_5.id, :course_id => course_0_B.id)
Enrollment.create(:user_id => student_6.id, :course_id => course_0_B.id)
Enrollment.create(:user_id => student_6.id, :course_id => course_0_C.id)
Enrollment.create(:user_id => student_7.id, :course_id => course_0_C.id)
Enrollment.create(:user_id => student_7.id, :course_id => course_0_D.id)
Enrollment.create(:user_id => student_8.id, :course_id => course_0_D.id)
Enrollment.create(:user_id => student_8.id, :course_id => course_0_E.id)
Enrollment.create(:user_id => student_9.id, :course_id => course_0_E.id)
Enrollment.create(:user_id => student_9.id, :course_id => course_0_A.id)
Enrollment.create(:user_id => student_10.id, :course_id => course_1_A.id)
Enrollment.create(:user_id => student_10.id, :course_id => course_1_B.id)
Enrollment.create(:user_id => student_11.id, :course_id => course_1_B.id)
Enrollment.create(:user_id => student_11.id, :course_id => course_1_C.id)
Enrollment.create(:user_id => student_12.id, :course_id => course_1_C.id)
Enrollment.create(:user_id => student_12.id, :course_id => course_1_D.id)
Enrollment.create(:user_id => student_13.id, :course_id => course_1_D.id)
Enrollment.create(:user_id => student_13.id, :course_id => course_1_E.id)
Enrollment.create(:user_id => student_14.id, :course_id => course_1_E.id)
Enrollment.create(:user_id => student_14.id, :course_id => course_1_A.id)
Enrollment.create(:user_id => student_15.id, :course_id => course_1_A.id)
Enrollment.create(:user_id => student_15.id, :course_id => course_1_B.id)
Enrollment.create(:user_id => student_16.id, :course_id => course_1_B.id)
Enrollment.create(:user_id => student_16.id, :course_id => course_1_C.id)
Enrollment.create(:user_id => student_17.id, :course_id => course_1_C.id)
Enrollment.create(:user_id => student_17.id, :course_id => course_1_D.id)
Enrollment.create(:user_id => student_18.id, :course_id => course_1_D.id)
Enrollment.create(:user_id => student_18.id, :course_id => course_1_E.id)
Enrollment.create(:user_id => student_19.id, :course_id => course_1_E.id)
Enrollment.create(:user_id => student_19.id, :course_id => course_1_A.id)
Enrollment.create(:user_id => student_20.id, :course_id => course_2_A.id)
Enrollment.create(:user_id => student_20.id, :course_id => course_2_B.id)
Enrollment.create(:user_id => student_21.id, :course_id => course_2_B.id)
Enrollment.create(:user_id => student_21.id, :course_id => course_2_C.id)
Enrollment.create(:user_id => student_22.id, :course_id => course_2_C.id)
Enrollment.create(:user_id => student_22.id, :course_id => course_2_D.id)
Enrollment.create(:user_id => student_23.id, :course_id => course_2_D.id)
Enrollment.create(:user_id => student_23.id, :course_id => course_2_E.id)
Enrollment.create(:user_id => student_24.id, :course_id => course_2_E.id)
Enrollment.create(:user_id => student_24.id, :course_id => course_2_A.id)
Enrollment.create(:user_id => student_25.id, :course_id => course_2_A.id)
Enrollment.create(:user_id => student_25.id, :course_id => course_2_B.id)
Enrollment.create(:user_id => student_26.id, :course_id => course_2_B.id)
Enrollment.create(:user_id => student_26.id, :course_id => course_2_C.id)
Enrollment.create(:user_id => student_27.id, :course_id => course_2_C.id)
Enrollment.create(:user_id => student_27.id, :course_id => course_2_D.id)
Enrollment.create(:user_id => student_28.id, :course_id => course_2_D.id)
Enrollment.create(:user_id => student_28.id, :course_id => course_2_E.id)
Enrollment.create(:user_id => student_29.id, :course_id => course_2_E.id)
Enrollment.create(:user_id => student_29.id, :course_id => course_2_A.id)
Enrollment.create(:user_id => student_30.id, :course_id => course_3_A.id)
Enrollment.create(:user_id => student_30.id, :course_id => course_3_B.id)
Enrollment.create(:user_id => student_31.id, :course_id => course_3_B.id)
Enrollment.create(:user_id => student_31.id, :course_id => course_3_C.id)
Enrollment.create(:user_id => student_32.id, :course_id => course_3_C.id)
Enrollment.create(:user_id => student_32.id, :course_id => course_3_D.id)
Enrollment.create(:user_id => student_33.id, :course_id => course_3_D.id)
Enrollment.create(:user_id => student_33.id, :course_id => course_3_E.id)
Enrollment.create(:user_id => student_34.id, :course_id => course_3_E.id)
Enrollment.create(:user_id => student_34.id, :course_id => course_3_A.id)
Enrollment.create(:user_id => student_35.id, :course_id => course_3_A.id)
Enrollment.create(:user_id => student_35.id, :course_id => course_3_B.id)
Enrollment.create(:user_id => student_36.id, :course_id => course_3_B.id)
Enrollment.create(:user_id => student_36.id, :course_id => course_3_C.id)
Enrollment.create(:user_id => student_37.id, :course_id => course_3_C.id)
Enrollment.create(:user_id => student_37.id, :course_id => course_3_D.id)
Enrollment.create(:user_id => student_38.id, :course_id => course_3_D.id)
Enrollment.create(:user_id => student_38.id, :course_id => course_3_E.id)
Enrollment.create(:user_id => student_39.id, :course_id => course_3_E.id)
Enrollment.create(:user_id => student_39.id, :course_id => course_3_A.id)
Enrollment.create(:user_id => student_40.id, :course_id => course_4_A.id)
Enrollment.create(:user_id => student_40.id, :course_id => course_4_B.id)
Enrollment.create(:user_id => student_41.id, :course_id => course_4_B.id)
Enrollment.create(:user_id => student_41.id, :course_id => course_4_C.id)
Enrollment.create(:user_id => student_42.id, :course_id => course_4_C.id)
Enrollment.create(:user_id => student_42.id, :course_id => course_4_D.id)
Enrollment.create(:user_id => student_43.id, :course_id => course_4_D.id)
Enrollment.create(:user_id => student_43.id, :course_id => course_4_E.id)
Enrollment.create(:user_id => student_44.id, :course_id => course_4_E.id)
Enrollment.create(:user_id => student_44.id, :course_id => course_4_A.id)
Enrollment.create(:user_id => student_45.id, :course_id => course_4_A.id)
Enrollment.create(:user_id => student_45.id, :course_id => course_4_B.id)
Enrollment.create(:user_id => student_46.id, :course_id => course_4_B.id)
Enrollment.create(:user_id => student_46.id, :course_id => course_4_C.id)
Enrollment.create(:user_id => student_47.id, :course_id => course_4_C.id)
Enrollment.create(:user_id => student_47.id, :course_id => course_4_D.id)
Enrollment.create(:user_id => student_48.id, :course_id => course_4_D.id)
Enrollment.create(:user_id => student_48.id, :course_id => course_4_E.id)
Enrollment.create(:user_id => student_49.id, :course_id => course_4_E.id)
Enrollment.create(:user_id => student_49.id, :course_id => course_4_A.id)
Enrollment.create(:user_id => student_50.id, :course_id => course_5_A.id)
Enrollment.create(:user_id => student_50.id, :course_id => course_5_B.id)
Enrollment.create(:user_id => student_51.id, :course_id => course_5_B.id)
Enrollment.create(:user_id => student_51.id, :course_id => course_5_C.id)
Enrollment.create(:user_id => student_52.id, :course_id => course_5_C.id)
Enrollment.create(:user_id => student_52.id, :course_id => course_5_D.id)
Enrollment.create(:user_id => student_53.id, :course_id => course_5_D.id)
Enrollment.create(:user_id => student_53.id, :course_id => course_5_E.id)
Enrollment.create(:user_id => student_54.id, :course_id => course_5_E.id)
Enrollment.create(:user_id => student_54.id, :course_id => course_5_A.id)
Enrollment.create(:user_id => student_55.id, :course_id => course_5_A.id)
Enrollment.create(:user_id => student_55.id, :course_id => course_5_B.id)
Enrollment.create(:user_id => student_56.id, :course_id => course_5_B.id)
Enrollment.create(:user_id => student_56.id, :course_id => course_5_C.id)
Enrollment.create(:user_id => student_57.id, :course_id => course_5_C.id)
Enrollment.create(:user_id => student_57.id, :course_id => course_5_D.id)
Enrollment.create(:user_id => student_58.id, :course_id => course_5_D.id)
Enrollment.create(:user_id => student_58.id, :course_id => course_5_E.id)
Enrollment.create(:user_id => student_59.id, :course_id => course_5_E.id)
Enrollment.create(:user_id => student_59.id, :course_id => course_5_A.id)
Enrollment.create(:user_id => student_60.id, :course_id => course_6_A.id)
Enrollment.create(:user_id => student_60.id, :course_id => course_6_B.id)
Enrollment.create(:user_id => student_61.id, :course_id => course_6_B.id)
Enrollment.create(:user_id => student_61.id, :course_id => course_6_C.id)
Enrollment.create(:user_id => student_62.id, :course_id => course_6_C.id)
Enrollment.create(:user_id => student_62.id, :course_id => course_6_D.id)
Enrollment.create(:user_id => student_63.id, :course_id => course_6_D.id)
Enrollment.create(:user_id => student_63.id, :course_id => course_6_E.id)
Enrollment.create(:user_id => student_64.id, :course_id => course_6_E.id)
Enrollment.create(:user_id => student_64.id, :course_id => course_6_A.id)
Enrollment.create(:user_id => student_65.id, :course_id => course_6_A.id)
Enrollment.create(:user_id => student_65.id, :course_id => course_6_B.id)
Enrollment.create(:user_id => student_66.id, :course_id => course_6_B.id)
Enrollment.create(:user_id => student_66.id, :course_id => course_6_C.id)
Enrollment.create(:user_id => student_67.id, :course_id => course_6_C.id)
Enrollment.create(:user_id => student_67.id, :course_id => course_6_D.id)
Enrollment.create(:user_id => student_68.id, :course_id => course_6_D.id)
Enrollment.create(:user_id => student_68.id, :course_id => course_6_E.id)
Enrollment.create(:user_id => student_69.id, :course_id => course_6_E.id)
Enrollment.create(:user_id => student_69.id, :course_id => course_6_A.id)
Enrollment.create(:user_id => student_70.id, :course_id => course_7_A.id)
Enrollment.create(:user_id => student_70.id, :course_id => course_7_B.id)
Enrollment.create(:user_id => student_71.id, :course_id => course_7_B.id)
Enrollment.create(:user_id => student_71.id, :course_id => course_7_C.id)
Enrollment.create(:user_id => student_72.id, :course_id => course_7_C.id)
Enrollment.create(:user_id => student_72.id, :course_id => course_7_D.id)
Enrollment.create(:user_id => student_73.id, :course_id => course_7_D.id)
Enrollment.create(:user_id => student_73.id, :course_id => course_7_E.id)
Enrollment.create(:user_id => student_74.id, :course_id => course_7_E.id)
Enrollment.create(:user_id => student_74.id, :course_id => course_7_A.id)
Enrollment.create(:user_id => student_75.id, :course_id => course_7_A.id)
Enrollment.create(:user_id => student_75.id, :course_id => course_7_B.id)
Enrollment.create(:user_id => student_76.id, :course_id => course_7_B.id)
Enrollment.create(:user_id => student_76.id, :course_id => course_7_C.id)
Enrollment.create(:user_id => student_77.id, :course_id => course_7_C.id)
Enrollment.create(:user_id => student_77.id, :course_id => course_7_D.id)
Enrollment.create(:user_id => student_78.id, :course_id => course_7_D.id)
Enrollment.create(:user_id => student_78.id, :course_id => course_7_E.id)
Enrollment.create(:user_id => student_79.id, :course_id => course_7_E.id)
Enrollment.create(:user_id => student_79.id, :course_id => course_7_A.id)
Enrollment.create(:user_id => student_80.id, :course_id => course_8_A.id)
Enrollment.create(:user_id => student_80.id, :course_id => course_8_B.id)
Enrollment.create(:user_id => student_81.id, :course_id => course_8_B.id)
Enrollment.create(:user_id => student_81.id, :course_id => course_8_C.id)
Enrollment.create(:user_id => student_82.id, :course_id => course_8_C.id)
Enrollment.create(:user_id => student_82.id, :course_id => course_8_D.id)
Enrollment.create(:user_id => student_83.id, :course_id => course_8_D.id)
Enrollment.create(:user_id => student_83.id, :course_id => course_8_E.id)
Enrollment.create(:user_id => student_84.id, :course_id => course_8_E.id)
Enrollment.create(:user_id => student_84.id, :course_id => course_8_A.id)
Enrollment.create(:user_id => student_85.id, :course_id => course_8_A.id)
Enrollment.create(:user_id => student_85.id, :course_id => course_8_B.id)
Enrollment.create(:user_id => student_86.id, :course_id => course_8_B.id)
Enrollment.create(:user_id => student_86.id, :course_id => course_8_C.id)
Enrollment.create(:user_id => student_87.id, :course_id => course_8_C.id)
Enrollment.create(:user_id => student_87.id, :course_id => course_8_D.id)
Enrollment.create(:user_id => student_88.id, :course_id => course_8_D.id)
Enrollment.create(:user_id => student_88.id, :course_id => course_8_E.id)
Enrollment.create(:user_id => student_89.id, :course_id => course_8_E.id)
Enrollment.create(:user_id => student_89.id, :course_id => course_8_A.id)
Enrollment.create(:user_id => student_90.id, :course_id => course_9_A.id)
Enrollment.create(:user_id => student_90.id, :course_id => course_9_B.id)
Enrollment.create(:user_id => student_91.id, :course_id => course_9_B.id)
Enrollment.create(:user_id => student_91.id, :course_id => course_9_C.id)
Enrollment.create(:user_id => student_92.id, :course_id => course_9_C.id)
Enrollment.create(:user_id => student_92.id, :course_id => course_9_D.id)
Enrollment.create(:user_id => student_93.id, :course_id => course_9_D.id)
Enrollment.create(:user_id => student_93.id, :course_id => course_9_E.id)
Enrollment.create(:user_id => student_94.id, :course_id => course_9_E.id)
Enrollment.create(:user_id => student_94.id, :course_id => course_9_A.id)
Enrollment.create(:user_id => student_95.id, :course_id => course_9_A.id)
Enrollment.create(:user_id => student_95.id, :course_id => course_9_B.id)
Enrollment.create(:user_id => student_96.id, :course_id => course_9_B.id)
Enrollment.create(:user_id => student_96.id, :course_id => course_9_C.id)
Enrollment.create(:user_id => student_97.id, :course_id => course_9_C.id)
Enrollment.create(:user_id => student_97.id, :course_id => course_9_D.id)
Enrollment.create(:user_id => student_98.id, :course_id => course_9_D.id)
Enrollment.create(:user_id => student_98.id, :course_id => course_9_E.id)
Enrollment.create(:user_id => student_99.id, :course_id => course_9_E.id)
Enrollment.create(:user_id => student_99.id, :course_id => course_9_A.id)
